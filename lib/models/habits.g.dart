...
int _habitEstimateSize(
  ...
  bytesCount += 3 + object.completed.length * 8;
...
void _habitSerialize(
  ...
  writer.writeDateTimeList(offsets[0], object.completed);
...
Habit _habitDeserialize(
  ...
  final object = Habit();
  object.completed = reader.readDateTimeList(offsets[0]) ?? [];
  object.id = id;
...
extension HabitQueryFilter on QueryBuilder<Habit, Habit, QFilterCondition> {
  QueryBuilder<Habit, Habit, QAfterFilterCondition> completedElementEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> completedElementGreaterThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> completedElementLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> completedElementBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> completedLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> completedIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'completed',
        0,
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> completedIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'completed',
        0,
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> completedLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> completedLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> completedLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension HabitQueryWhereDistinct on QueryBuilder<Habit, Habit, QDistinct> {
  QueryBuilder<Habit, Habit, QDistinct> distinctByCompleted() {
    return QueryBuilder.apply(this, (query) {
...
extension HabitQueryProperty on QueryBuilder<Habit, Habit, QQueryProperty> {
  ...
  QueryBuilder<Habit, List<DateTime>, QQueryOperations> completedProperty() {
    return QueryBuilder.apply(this, (query) {
